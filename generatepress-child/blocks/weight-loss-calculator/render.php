...
$heading_styles = [];
if (!empty($attrs['headingColor']))    $heading_styles[] = 'color:' . esc_attr($attrs['headingColor']);
if (!empty($attrs['headingFontSize'])) $heading_styles[] = 'font-size:' . esc_attr($attrs['headingFontSize']);
$heading_style_attr = $heading_styles ? ' style="' . esc_attr(implode(';', $heading_styles)) . '"' : '';

// Support text inline styles
$support_styles = [];
if (!empty($attrs['supportingColor']))    $support_styles[] = 'color:' . esc_attr($attrs['supportingColor']);
if (!empty($attrs['supportingFontSize'])) $support_styles[] = 'font-size:' . esc_attr($attrs['supportingFontSize']);
